[![CI](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml/badge.svg?branch=26.2)](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml)
...
This branch builds Minecraft 26.2 for Fabric and NeoForge.
