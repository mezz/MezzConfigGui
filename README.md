[![CI](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml/badge.svg?branch=26.3)](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml)
...
This branch builds Minecraft 26.3 for Fabric and NeoForge.
