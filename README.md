[![CI](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml/badge.svg?branch=1.19.2)](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml)
...
This branch builds Minecraft 1.19.2 for Fabric and Forge.
