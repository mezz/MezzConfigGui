[![CI](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml/badge.svg?branch=1.21.11)](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml)
...
This branch builds Minecraft 1.21.11 for Fabric and NeoForge.
