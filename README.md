[![CI](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml/badge.svg?branch=26.1.2)](https://github.com/mezz/MezzConfigGui/actions/workflows/ci.yml)
...
This branch builds Minecraft 26.1.2 for Fabric and NeoForge.
See [Minecraft branches](docs/BRANCHES.md) for the other supported versions.
Run Gradle with Java 25.
