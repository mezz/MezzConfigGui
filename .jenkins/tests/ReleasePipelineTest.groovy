...
def env = [BRANCH_NAME: '1.21.1', CHANGE_ID: null, RELEASE_TAG: 'v0.3.0/mc1.21.1']
...
currentBuild.previousBuild.previousBuild = [
    result: 'SUCCESS',
    description: jenkins.releaseMarker('v0.3.0/mc1.21.1'),
    previousBuild: null
]
assert !jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.1/mc1.21.1'
assert jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.0/mc1.21.1'
...
env.RELEASE_TAG = 'refs/tags/v0.3.0/mc1.21.1'
assert jenkins.getReleaseVersion() == '0.3.0'
