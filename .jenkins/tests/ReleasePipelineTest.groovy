...
def env = [BRANCH_NAME: '1.19.2', CHANGE_ID: null, RELEASE_TAG: 'mc1.19.2/v0.3.0']
...
env.RELEASE_TAG = 'mc1.19.2/v0.3.0'
...
currentBuild.previousBuild.previousBuild = [
    result: 'SUCCESS',
    description: jenkins.releaseMarker('mc1.19.2/v0.3.0'),
    previousBuild: null
]
assert !jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'mc1.19.2/v0.3.1'
assert jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'mc1.19.2/v0.3.0'
...
env.RELEASE_TAG = 'refs/tags/mc1.19.2/v0.3.0'
assert jenkins.getReleaseVersion() == '0.3.0'
