...
def env = [BRANCH_NAME: '26.3', CHANGE_ID: null, RELEASE_TAG: 'v0.3.0/mc26.3']
...
currentBuild.previousBuild.previousBuild = [
    result: 'SUCCESS',
    description: jenkins.releaseMarker('v0.3.0/mc26.3'),
    previousBuild: null
]
assert !jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.1/mc26.3'
assert jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.0/mc26.3'
...
env.RELEASE_TAG = 'refs/tags/v0.3.0/mc26.3'
assert jenkins.getReleaseVersion() == '0.3.0'
