...
def env = [BRANCH_NAME: '26.1.2', CHANGE_ID: null, RELEASE_TAG: 'mc26.1.2/v0.3.0']
...
env.RELEASE_TAG = 'mc26.1.2/v0.3.0'
...
currentBuild.previousBuild.previousBuild = [
    result: 'SUCCESS',
    description: jenkins.releaseMarker('mc26.1.2/v0.3.0'),
    previousBuild: null
]
assert !jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'mc26.1.2/v0.3.1'
assert jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'mc26.1.2/v0.3.0'
...
env.RELEASE_TAG = 'refs/tags/mc26.1.2/v0.3.0'
assert jenkins.getReleaseVersion() == '0.3.0'
