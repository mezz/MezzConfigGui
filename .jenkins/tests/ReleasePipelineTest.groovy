...
def env = [BRANCH_NAME: '1.19.2', CHANGE_ID: null, RELEASE_TAG: 'v0.3.0/mc1.19.2']
...
env.RELEASE_TAG = 'v0.3.0/mc1.19.2'
...
currentBuild.previousBuild.previousBuild = [
    result: 'SUCCESS',
    description: jenkins.releaseMarker('v0.3.0/mc1.19.2'),
    previousBuild: null
]
assert !jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.1/mc1.19.2'
assert jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.0/mc1.19.2'
...
env.RELEASE_TAG = 'refs/tags/v0.3.0/mc1.19.2'
assert jenkins.getReleaseVersion() == '0.3.0'
