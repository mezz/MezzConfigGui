...
def env = [BRANCH_NAME: '1.21.11', CHANGE_ID: null, RELEASE_TAG: 'v0.3.0/mc1.21.11']
...
env.RELEASE_TAG = 'v0.3.0/mc1.21.11'
...
currentBuild.previousBuild.previousBuild = [
    result: 'SUCCESS',
    description: jenkins.releaseMarker('v0.3.0/mc1.21.11'),
    previousBuild: null
]
assert !jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.1/mc1.21.11'
assert jenkins.shouldPublishRelease()
env.RELEASE_TAG = 'v0.3.0/mc1.21.11'
...
env.RELEASE_TAG = 'refs/tags/v0.3.0/mc1.21.11'
assert jenkins.getReleaseVersion() == '0.3.0'
