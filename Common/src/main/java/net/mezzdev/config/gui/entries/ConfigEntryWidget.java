...
public abstract class ConfigEntryWidget<T> {
	...
	public static void drawText(LegacyGuiGraphics guiGraphics, Font font, FormattedCharSequence text, int x, int y, int color) {
		guiGraphics.drawString(font, text, x, y, color, false);
	}

	public static void drawText(LegacyGuiGraphics guiGraphics, Font font, Component text, int x, int y, int color) {
		guiGraphics.drawString(font, text, x, y, color, false);
	}

	public static void drawText(LegacyGuiGraphics guiGraphics, Font font, String text, int x, int y, int color) {
		guiGraphics.drawString(font, text, x, y, color, false);
	}

	public static boolean drawCenteredButtonText(LegacyGuiGraphics guiGraphics, Font font, Component text, ImmutableRect2i area, int color) {
	...
	public static boolean drawCenteredButtonText(LegacyGuiGraphics guiGraphics, Font font, String text, ImmutableRect2i area, int color) {
	...
	public void draw(LegacyGuiGraphics guiGraphics, double mouseX, double mouseY, boolean allowHover) {
		draw(guiGraphics, mouseX, mouseY, allowHover, -1);
	}

	public final void draw(LegacyGuiGraphics guiGraphics, double mouseX, double mouseY, boolean allowHover, int rowIndex, ImmutableRect2i viewport) {
	...
	public void draw(LegacyGuiGraphics guiGraphics, double mouseX, double mouseY, boolean allowHover, int rowIndex) {
	...
	private void drawRowStripe(LegacyGuiGraphics guiGraphics, int rowIndex) {
	...
	private void drawResetButton(LegacyGuiGraphics guiGraphics, double mouseX, double mouseY) {
	...
	protected final void drawName(LegacyGuiGraphics guiGraphics) {
		Font font = Minecraft.getInstance().font;
		int scaledLineHeight = getScaledLineHeight(font);
		int y = nameArea.getY();
	...
	protected abstract void drawContent(LegacyGuiGraphics guiGraphics, double mouseX, double mouseY);
