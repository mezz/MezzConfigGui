...
public final class ConfigCheckbox {
	...
	public static void draw(LegacyGuiGraphics guiGraphics, ImmutableRect2i area, boolean checked, boolean hovered) {
		draw(guiGraphics, area.getX(), area.getY(), area.getWidth(), area.getHeight(), checked, hovered);
	}

	public static void draw(LegacyGuiGraphics guiGraphics, Rect2i area, boolean checked, boolean hovered) {
		draw(guiGraphics, area.getX(), area.getY(), area.getWidth(), area.getHeight(), checked, hovered);
	}
