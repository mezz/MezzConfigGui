...
public final class ConfigScreenOwnerIcon {
	...
	public void draw(GuiGraphicsExtractor guiGraphics, Font font, ImmutableRect2i iconArea) {
	...
	private void drawPlaceholder(GuiGraphicsExtractor guiGraphics, Font font, ImmutableRect2i iconArea) {
	...
	private static void drawMinecraftIcon(GuiGraphicsExtractor guiGraphics, ImmutableRect2i iconArea) {
		...
		ConfigRenderUtil.scale(guiGraphics, scale, scale, 1.0F);
		guiGraphics.fakeItem(MinecraftIconHolder.ICON, 0, 0);
		ConfigRenderUtil.popPose(guiGraphics);
	}
	...
	private static void drawIconBorder(GuiGraphicsExtractor guiGraphics, ImmutableRect2i iconArea) {
		guiGraphics.fill(
			iconArea.getX() - 1,
			iconArea.getY() - 1,
	...
	private record LoadedIcon(
		...
		public void draw(GuiGraphicsExtractor guiGraphics, ImmutableRect2i iconArea) {
			drawIconBorder(guiGraphics, iconArea);
