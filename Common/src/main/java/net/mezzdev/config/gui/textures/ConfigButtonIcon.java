...
public enum ConfigButtonIcon {
	...
	public void draw(LegacyGuiGraphics guiGraphics, ImmutableRect2i area, boolean active) {
		draw(guiGraphics, area.getX(), area.getY(), area.getWidth(), area.getHeight(), active);
	}

	public void draw(LegacyGuiGraphics guiGraphics, Rect2i area, boolean active) {
		draw(guiGraphics, area.getX(), area.getY(), area.getWidth(), area.getHeight(), active);
	}

	void draw(LegacyGuiGraphics guiGraphics, int areaX, int areaY, int areaWidth, int areaHeight, boolean active) {
