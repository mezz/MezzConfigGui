...
public final class ColorSwatch {
	...
	public static void draw(GuiGraphicsExtractor guiGraphics, Rect2i area, PackedColor color) {
		draw(guiGraphics, area, color.packedValue(), color.format());
	}

	public static void draw(GuiGraphicsExtractor guiGraphics, ImmutableRect2i area, PackedColor color) {
	...
	public static void draw(GuiGraphicsExtractor guiGraphics, Rect2i area, int color, ConfigColorFormat format) {
	...
	public static void drawCheckerboard(GuiGraphicsExtractor guiGraphics, int x, int y, int right, int bottom) {
