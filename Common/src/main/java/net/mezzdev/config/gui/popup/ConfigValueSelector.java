...
public final class ConfigValueSelector<T> implements IConfigValuePopup<T> {
	...
	private static void drawEntryBackground(LegacyGuiGraphics guiGraphics, ImmutableRect2i valueArea, boolean hovered, boolean drawDivider) {
	...
	private void drawScrollbar(LegacyGuiGraphics guiGraphics, ImmutableRect2i contentArea) {
