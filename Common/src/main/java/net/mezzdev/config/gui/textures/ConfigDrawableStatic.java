...
public final class ConfigDrawableStatic {
	...
	public void draw(LegacyGuiGraphics guiGraphics, int xOffset, int yOffset) {
		draw(guiGraphics, xOffset, yOffset, 0, 0, 0, 0);
	}

	public void draw(LegacyGuiGraphics guiGraphics, int xOffset, int yOffset, int maskTop, int maskBottom, int maskLeft, int maskRight) {
		TextureAtlasSprite sprite = getSprite();
	...
	public void drawTinted(LegacyGuiGraphics graphics, int x, int y, int color) {
		TextureAtlasSprite sprite = getSprite();
		int width = getWidth(sprite);
		int height = getHeight(sprite);
