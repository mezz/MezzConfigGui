...
public final class ConfigInputUtil {
	...
	public static boolean keyPressed(net.mezzdev.config.gui.LegacyEditBox box, int key, int scanCode, int modifiers) { return box.keyPressed(key, scanCode, modifiers); }
	public static boolean charTyped(net.mezzdev.config.gui.LegacyEditBox box, char character, int modifiers) { return box.charTyped(character, modifiers); }
