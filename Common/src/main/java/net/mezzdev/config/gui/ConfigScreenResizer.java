...
public final class ConfigScreenResizer {
	...
	private static void drawResizeGrip(LegacyGuiGraphics guiGraphics, ImmutableRect2i area, boolean hovered) {
	...
	private static void drawResizeGripLine(LegacyGuiGraphics guiGraphics, int x1, int y1, int x2, int y2, int color) {
